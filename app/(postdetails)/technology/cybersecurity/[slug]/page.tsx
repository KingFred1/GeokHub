  ...
  try {
    ...
    const description =
      ...
      (post.body
        ...
        : "Cybersecurity insights and best practices on GeokHub");
    ...
    return {
      ...
      openGraph: {
        ...
        authors: [post.author?.name || "GeokHub Cybersecurity Team"],
        images: [{ url: imageUrl, width: 1200, height: 630, alt: post.title }],
        siteName: "GeokHub Cybersecurity",
      },
      twitter: {
...
function getSecurityCategory(securityType: string): string {
  if (!securityType) return "General Security";
  ...
  const securityLower = securityType.toLowerCase();
  for (const [key, value] of Object.entries(securityMap)) {
    if (securityLower.includes(key)) return value;
  }
...
// MAIN COMPONENT
export default async function CybersecurityDetailPage({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  try {
    ...
    const [
      cybersecurityPosts,
      relatedCybersecurityPosts,
      trendingCybersecurity,
    ] = await Promise.all([
      client.fetch(
        BLOG_BY_CATEGORY_SLUG,
        { slug: "cybersecurity" },
      ...
      client.fetch(
        `*[_type == "post" && count((categories[]->slug.current)[@ in ["cybersecurity", "security"]]) > 0] | order(views desc)[0...5] {
          _id,
          title,
          "slug": slug.current,
          publishedAt,
    ...
    const cybersecurityPostsWithUrls =
      cybersecurityPosts?.map((post: any) => ({
        ...post,
        url: getPostUrl(post),
      })) || [];

    const relatedCybersecurityPostsWithUrls =
      relatedCybersecurityPosts?.map((post: any) => ({
        ...post,
        url: getPostUrl(post),
      })) || [];

    const trendingCybersecurityWithUrls =
      trendingCybersecurity?.map((post: any) => ({
        ...post,
        url: getPostUrl(post),
      })) || [];
    ...
    const securityCategory = getSecurityCategory(post.technologyType);
    ...
    const jsonLd = {
      ...
      author: {
        "@type": "Person",
        name: post.author?.name || "GeokHub Cybersecurity Team",
      ...
      publisher: {
        ...
        logo: {
          "@type": "ImageObject",
          url: `${baseUrl}/icons/geokhub-security.png`,
        },
      },
      articleSection: post.categories?.[0]?.title || "Cybersecurity",
      ...(post.threatLevel && { keywords: post.threatLevel }),
      ...(post.severity && { contentRating: post.severity }),
    };
    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-background dark:bg-background-dark">
          {/* Cybersecurity Navigation Indicator */}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">
                    CYBERSECURITY • {securityCategory.toUpperCase()}
                  </span>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-0 md:px-4 lg:px-6 py-8">
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="sticky top-32 space-y-6 z-30">
                  ...
                  <div className="bg-card dark:card rounded-2xl p-4 shadow-lg border border-gray-100 dark:border-gray-700">
                    <div className="flex flex-col items-center">
                      <Eye className="h-6 w-6 text-gray-600 dark:text-gray-400 mb-2" />
                  ...
                  <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-4 text-white text-center">
                    <Lock className="h-6 w-6 mx-auto mb-2" />
                    <div className="text-sm font-bold">
                      {securityCategory.split(" ")[0]}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="flex-1 max-w-4xl mx-auto">
                {/* Security Alert */}
                {post.threatLevel && (
                  <div className="mb-8 bg-gradient-to-r from-red-900 via-red-800 to-amber-900 text-white p-4 rounded-2xl shadow-lg">
                ...
                {/* Security Info */}
                {(post.technologyType || post.severity) && (
                  <div className="mb-6">
                    <div className="flex items-center gap-4 flex-wrap">
                      {post.technologyType && (
                        <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 px-4 py-2 rounded-xl">
                        ...
                        <div
                          className={`flex items-center gap-2 px-4 py-2 rounded-xl ${
                            post.severity.toLowerCase() === "high"
                              ? "bg-gradient-to-r from-red-50 to-orange-50 dark:from-red-900/30 dark:to-orange-900/30 text-red-700 dark:text-red-300"
                ...
                <div className="mb-10 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900/20 dark:to-gray-800/20 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <article className="mb-12 max-w-7xl mx-auto px-4 lg:px-0">
                  <div className="prose prose-lg md:prose-xl dark:prose-invert max-w-none">
                    <div
                      ...
                      prose-headings:border-gray-600
                      prose-headings:pl-4
                      ...
                      prose-blockquote:dark:bg-gray-900/20
                      ...
                      dark:first-letter:text-gray-300
                    ...
                    <div className="flex flex-wrap gap-3">
                      {post.keywords.map((tag: string, index: number) => (
                        <Link
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 text-gray-700 dark:text-gray-300 hover:from-gray-200 hover:to-gray-300 dark:hover:from-gray-700 dark:hover:to-gray-800 rounded-full text-sm font-medium transition-all duration-200 border border-gray-200 dark:border-gray-700"
                        >
                          #{tag}
                        </Link>
                      ))}
              ...
              <aside className="lg:w-80">
                <div className="sticky top-32 space-y-8">
                  ...
                  <div className="bg-card rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <div className="p-2">
                      {trendingCybersecurityWithUrls?.length > 0 ? (
                        trendingCybersecurityWithUrls
                          .slice(1, 4)
                          .map((postItem: any, index: number) => {
                            ...
                            return (
                              ...
                              >
                                <div className="flex gap-3 p-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl transition-all duration-200">
                                  <div className="flex-shrink-0">
                                    <div className="w-8 h-8 flex items-center justify-center bg-gradient-to-br from-gray-700 to-gray-900 text-white rounded-lg font-bold text-sm">
                                      {index + 1}
                                    </div>
                                  </div>
                                  <div className="flex-1 min-w-0">
                                    <h3 className="font-semibold text-gray-900 dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300 line-clamp-2 text-sm">
                                      {postItem.title}
                                    </h3>
                                    <div className="flex items-center justify-between mt-1">
                                      ...
                                      {postItem.threatLevel && (
                                        <span
                                          className={`text-xs font-bold ${
                                            postItem.threatLevel.toLowerCase() ===
                                            "high"
                  ...
                  {/* <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-6 text-white">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="text-xl font-bold">Security Brief</h3>
            ...
            {/* Related Cybersecurity Section */}
            {relatedCybersecurityPostsWithUrls &&
              relatedCybersecurityPostsWithUrls.length > 0 && (
                <section className="mt-20 max-w-7xl mx-auto px-4 md:px-0">
                  ...
                  <div className="text-center mt-12">
                    <Link
                      ...
                      className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 text-white rounded-full font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
                      Explore All Cybersecurity
    ...
    console.error("Cybersecurity page error:", error);
    notFound();
  }
}
